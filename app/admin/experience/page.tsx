    ...
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <div className="space-y-5">
          {experiences.map((exp) => (
            <div key={exp.id} className="list-item flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6">
              {/* Logo */}
              ...
              {/* Actions */}
              <div className="flex gap-3 shrink-0 sm:ml-auto w-full sm:w-auto mt-2 sm:mt-0">
